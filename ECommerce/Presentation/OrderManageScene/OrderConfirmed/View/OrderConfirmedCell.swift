...
final class OrderConfirmedCell: UITableViewCell {
    ...
    private var item: OrderConfirmedItemModel?
    
    func fill(with item: OrderConfirmedItemModel) {
        self.item = item
